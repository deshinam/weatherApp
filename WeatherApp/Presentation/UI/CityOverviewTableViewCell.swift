...
final class CityOverviewTableViewCell: UITableViewCell {
    ...
    private struct Constants {
        ...
        static let defaultImageName = "no"
    }
    ...
    var city: CityWeather? {
        ...
        cityTemputureLabel.text =  city?.temputure
            cityWeatherImage.image = UIImage(systemName: city?.conditionName ?? Constants.defaultImageName)
        }
    }
    ...
    private var cityTemputureLabel: UILabel = {
        let label = UILabel()
        label.font = UIFont.boldSystemFont(ofSize: Constants.cityLabelFont)
